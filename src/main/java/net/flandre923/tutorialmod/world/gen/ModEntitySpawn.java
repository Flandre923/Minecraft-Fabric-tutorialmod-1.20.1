...
public class ModEntitySpawn {
    public static void addEntitySpawn(){
        ...
        SpawnRestriction.register(ModEntities.CHOMPER, SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, HostileEntity::canSpawnInDark);
    }
}
